...
const Index = ({ jokeContract, address }) => {
            ...
            <section className="container-fluid about">
                <div className="row">
                    <div className="col-12 mt-4">
                        <h1 className="text-center text-dark">Tell a joke </h1>
                ...
                <div className="row">
                    <div className="col-12">
                        <h4 className="text-center text-uppercase color1 my-4">Rate the jokes of other participants</h4>
                    </div>
                </div>
                {allJokesArray ?
